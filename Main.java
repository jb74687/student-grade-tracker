...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("8. View Class Rankings");
            ...
            if (choice == 1) {
                ...
                for (Student s : gradebook.getStudents()) {
                    System.out.println(s.getName() + " | Avg: " + s.getAverage() + " | Grade: " + s.getLetterGrade() + " | GPA: " + s.getGPA() + " | High: " + s.getHighest() + " | Low: " + s.getLowest());
                }
